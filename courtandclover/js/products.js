...
window.CC_PRODUCTS = {
  rather: {
    ...
    extraViews: [
      { src: "assets/tee-rather-detail.svg", label: "View: print close-up", alt: "Close crop of the Rather Be Playing print, showing the texture of the ink on garment-dyed cotton" },
      { src: "assets/tee-rather-flatlay.svg", label: "View: size-context flat lay", alt: "Flat lay of the tee with width and length measurements marked for size context" }
    ]
  },
  kitchen: {
...
window.CC_COLORS = [
  { name: "Ivory", slug: "ivory", hex: "#F0EAD9" },
...
window.CC_IMG = function (designSlug, colorName) {
  ...
  return "assets/tee-" + designSlug + "-" + (color ? color.slug : "ivory") + ".svg";
};
